...
import spectro.thread.ThreadMul;
...
public class AppMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //====== 공유 객체 : 설정정보 셋팅 ===================
        Config configSensor = new Config("kosauser", "12345", "100", "http://192.168.0.30:8080/myweb/piserver");
        //Config configSensor = new Config("kosauser", "12345", "100","http://localhost:8080/myweb/piserver");
        ...
        configSensor.setBoolReferenceValueAutoGas(true);
        configSensor.setIntReferenceValueGas(170);
        ...
        configSensor.setIntReferenceValueUltrasonic(190);       //문과 센서의 거리 기준값(cm) 지정 
        //====================================================
        ...
        //
        System.out.println("■ 라즈베리파이 IOT Client 제어 프로그램 ■");
        //System.out.println("== 1. 서버 접속 확인 완료");
        //System.out.println("== 2. 계정 확인 완료");
        //System.out.println("== 3. Room 확인 완료");
        System.out.println("== 1초뒤 센서 구동 및 Http 통신 시작");
        Thread.sleep(1000);

        
        /*
        ThreadMul thread = new ThreadMul(configSensor);
        thread.start();
        */
