...
public class AppMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //====== 공유 객체 : 설정정보 셋팅 ===================
        Config configSensor = new Config("kosauser", "12345", "102", "http://192.168.0.30:8080/myweb/piserver");
        //Config configSensor = new Config("kosauser", "12345", "102","http://localhost:8080/myweb/piserver");
