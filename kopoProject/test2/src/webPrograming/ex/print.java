...
//		System.out.printf("%-86.86s%d\n", "주문합계", k07_iPrice);
		System.out.printf("%-80.80s", "주문합계");
		System.out.printf("%10.10s\n",  df.format(k07_iPrice));
		System.out.printf("%-80.80s", "할인금액");
		System.out.printf("%15.15s\n",  df.format(0));
		System.out.printf("%-80.80s", "받을금액");
		System.out.printf("%10.10s\n",  df.format(k07_iPrice));
		System.out.printf("-----------------------------------------------------\n");
		System.out.printf("%-18.18s %6.6s", "현   금", df.format(cash));
		System.out.printf("%10.10s%14.14s\n", "과   세", df.format(k07_beforMoney));
		System.out.printf("%-18.18s %6.6s", "카   드", df.format(card));
		System.out.printf("%10.10s%14.14s\n", "세   액", df.format(k07_tax));
		System.out.printf("%-18.18s%6.6s", "포인트", df.format(0));
		System.out.printf("%10.10s%14.14s\n", "면   세", df.format(0));
		System.out.printf("%35.35s%14.14s\n", "영수금액", df.format(k07_iPrice));
		System.out.printf("-----------------------------------------------------\n");
		if(card != 0){
